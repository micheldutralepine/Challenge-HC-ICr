        ...
        <div className="relatos-container">
          ...
          <div className="depoimentos">
            <div className="depoimento1">
              ...
              <p>
                "A Dra. Fernanda é a melhor! Ela sempre nos recebe com um
                sorriso e brinca comigo durante a consulta. Minha mãe disse que
                ela explica tudo muito bem e sempre nos deixa confortáveis.
                Gosto de ir ao ICr porque sei que vou ver a Dra. Fernanda!"
              </p>
            </div>
            <div className="depoimento2">
              ...
              <p>
                "A ressonância magnética da minha filha no Instituto da Criança
                e do Adolescente foi tranquila e eficiente. Agendamento fácil,
                atendimento pontual, técnico gentil explicando tudo. Recebemos
                os resultados rapidamente. Ótima experiência!"
              </p>
            </div>
            <div className="depoimento3">
              ...
              <p>
                "Quando tive que ficar no hospital por alguns dias, fui para a
                ala pediátrica do ICr. Lá é muito legal! As enfermeiras são
                super simpáticas e brincaram comigo o tempo todo. Até ganhei um
                brinquedo novo!"
              </p>
            </div>
            <div className="depoimento4">
              ...
              <p>
                ...
                ser. Depois da cirurgia, ele veio me ver e disse que eu fui
                muito corajosa. Obrigada, Dr. Pedro!"
              </p>
            </div>
            <div className="depoimento5">
              ...
              <p>
                ...
                técnico foi bem legal comigo, ele me deu um fone de ouvido para
                eu ouvir música durante o exame. Não doeu nada e eu até consegui
                ver as fotos depois. Muito obrigado!"
              </p>
            </div>
            ...
            <div className="depoimento6">
              ...
              <p>
                ...
                Adolescente. Fomos recebidas com muito cuidado e atenção. O
                médico explicou tudo de forma clara e fez um plano de tratamento
                eficaz. Estamos muito gratas pelo excelente atendimento
                recebido."
              </p>
            </div>
          </div>
