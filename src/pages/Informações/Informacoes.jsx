        ...
        <div className="container-informacoes">
          <div className=" container_1">
            ...
            <p>
              ...
              ⮕ Usuário:
              <br />
              1. CPF e RG ou certidão de nascimento em caso de menor de idade
              (originais e cópias). <br />
              2. Comprovante de endereço (original e cópia), com CEP (conta de
              água, luz ou telefone).
              <br />
              ⮕ Responsável:
              <br />
              1. RG (original). <br /> 2. Comprovante de endereço (original),
              com CEP (conta de água, luz ou telefone).
            </p>
            <a href="https://www.sptrans.com.br/atende/requisitos">
              Requisitos/Inscrição no Atende+
            </a>
            <p>
              <br />• Caso você já tenha cadastro, abaixo há o link de acesso ao
              portal deles:
            </p>
          ...
          <div className=" container_1">
            ...
            <br />
            <p>
              A Secretaria Municipal de Saúde de São Paulo estabelece critérios
              para dispensar fraldas a pessoas com incontinência urinária ou
              fecal. Inclusão baseada em condições médicas específicas.
              <br />
              <br />
              ⮕ Limite de 120 fraldas por mês para incontinência urinária e 30
              para fecal.
              <br />
              ⮕ Documentos necessários incluem RG, CPF, CNS e comprovante de
              endereço.
              <br />
              ⮕ Renovação anual do processo e registro no SIGA IPD.
              <br />
              ⮕ Critérios de desligamento incluem ausência prolongada e má
              conduta.
              <br />⮕ Referências médicas e formulários específicos são
              essenciais.
            </p>
            <br />
            <span>
              • Para mais informações e acesso ao formulário de cadastro:
            </span>
            <br />
            <a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjJxZiuwpSGAxUHpZUCHSsEDQ4QFnoECBMQAQ&url=https%3A%2F%2Fwww.prefeitura.sp.gov.br%2Fcidade%2Fsecretarias%2Fupload%2Fsaude%2FOrientacao_dispensacao_fraldas_12_6_2023.pdf&usg=AOvVaw1ihgd432E3PGuq1Fu8ylW9&opi=89978449">
              {" "}
              Clique Aqui!{" "}
            </a>
          </div>
          <div className=" container_1">
            ...
            <span>
              {" "}
              • Endereço: Av. Dr. Enéas Carvalho de Aguiar, 647 - Cerqueira
              César, São Paulo - SP, 05403-000{" "}
            </span>
          </div>
          <div className="container_1">
            ...
            <p>
              <b>• Instituto da Criança e do Adolescente (ICr)</b>
            </p>
            <br />
            <p>
              <b>⮕ Telefone:</b>(11) 2661-8500
            </p>
            <br />
            <p>
              <b>⮕ Agendar Consultas</b> – de 2ª a 6ª feira
            </p>
            <br />
            ...
            <br />
            <p>
              (11) 2661-8548 ou (11) 2661-8670 <br />
              Ou pessoalmente no 2º andar do ICr – das 11:00 às 15:00
            </p>
          </div>
        </div>
      </section>
